 ...
 *  The message unit (TDeskMessageCell) is a general term for the bubble message/picture message/emoticon message/video message displayed in the chat view.
 ...
 *
 *  The interaction callbacks provided by the TDeskMessageCellDelegate protocol include: long press, resend, click on the message, click on the avatar, etc.
 *  The TDeskMessageCell class stores message-related information, such as the sender's avatar, sender's nickname, and message content (supports various formats
...
@protocol TDeskMessageCellProtocol <NSObject>
...
@protocol TDeskMessageCellDelegate <NSObject>
 ...
 */
- (void)onSelectReadReceipt:(TDeskMessageCellData *)cell;
...
@interface TDeskMessageCell : TDeskCommonTableViewCell <TDeskMessageCellProtocol>
 ...
 */
@property (nonatomic, strong) TDeskSecurityStrikeView * securityStrikeView;

/**
 *  Message reply details button
 */
@property(nonatomic, strong) TDeskFitButton *messageModifyRepliesButton;
 ...
 * icon, etc. For details of messageData, please refer to: TUIChat\Cell\CellData\TDeskMessageCellData.h
 */
@property(readonly) TDeskMessageCellData *messageData;
...
@property(nonatomic, weak) id<TDeskMessageCellDelegate> delegate;
...
@interface TDeskMessageCell (TUILayoutConfiguration)
