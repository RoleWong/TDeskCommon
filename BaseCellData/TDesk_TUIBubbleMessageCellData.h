...
/**
 *
 *  - This file declares the TDeskBubbleMessageCellData class.
 *  - This class inherits from TDeskMessageCellData and is used to store a series of data and information required by the bubble message unit.
...
/**
 *
 * 【Module name】TDeskBubbleMessageCellData
 ...
 *  - Both TDeskFileMessageCellData and TDeskVoiceMessageCellData inherit from this class and implement the UI of bubble messages.
 */
@interface TDeskBubbleMessageCellData : TDeskMessageCellData
