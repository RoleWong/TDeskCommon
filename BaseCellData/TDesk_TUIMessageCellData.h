...
/**
 *
 * This file declares the TDeskMessageCellData class.
...
@class TDeskRelationUserModel;

NS_ASSUME_NONNULL_BEGIN

typedef void (^TDeskDownloadProgress)(NSInteger curSize, NSInteger totalSize);
typedef void (^TDeskDownloadResponse)(int code, NSString *desc, NSString *path);

/**
 *  The definition of message status
 */
typedef NS_ENUM(NSUInteger, TDeskMsgStatus) {
 ...
 */
typedef NS_ENUM(NSUInteger, TDeskMsgDirection) {
 ...
 */
typedef NS_ENUM(NSUInteger, TDeskMsgSource) {
...
/**
 * 【Module name】TDeskMessageCellData
 ...
 * SDK.
 */
@interface TDeskMessageCellData : TDeskCommonCellData
/**
 ...
 * - Message direction affects UI styles such as bubble icons, bubble positions, etc.
 */
@property(nonatomic, assign) TDeskMsgDirection direction;

/**
 * Message status
 */
@property(nonatomic, assign) TDeskMsgStatus status;

/**
 * Message source
 */
@property(nonatomic, assign) TDeskMsgSource source;
 ...
 *  For details, please refer to Section\Chat\CellLayout\TDeskMessageCellLayout.h
 */
@property(nonatomic, strong) TDeskMessageCellLayout *cellLayout;
...
@property(nonatomic, strong) TDeskMessageCellData* _Nullable placeHolderCellData;
 ...
 */
- (instancetype)initWithDirection:(TDeskMsgDirection)direction NS_DESIGNATED_INITIALIZER;
 ...
 * You can override the requestForAdditionalUserInfo method in your custom TDeskMessageCellData to return the user IDs which you want to retrieve, and directly use the additionalUserInfoResult property in your custom TDeskMessageCell to render the UI as needed.
...
@property(nonatomic, strong) NSDictionary<NSString *, TDeskRelationUserModel *> *additionalUserInfoResult;
...
/**
 * 【Module name】TDeskMessageCellDataFileUploadProtocol
 * 【Function description】File type message, unified upload (send) progress field
 */
@protocol TDeskMessageCellDataFileUploadProtocol <NSObject>
...
@protocol TDeskMessageCellDataFileDownloadProtocol <NSObject>
