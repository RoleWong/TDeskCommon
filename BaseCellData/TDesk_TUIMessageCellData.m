...
@interface TDeskMessageCellData ()

@end

@implementation TDeskMessageCellData
{
    NSString *_msgID;
...
- (TDeskMessageCellLayout *)cellLayout:(TDeskMsgDirection)direction {
    if (direction == MsgDirectionIncoming) {
        return [TDeskMessageCellLayout incommingMessageLayout];
    } else {
        return [TDeskMessageCellLayout outgoingMessageLayout];
    }
}
