...
- (void)setRtlAlignment:(TDeskTextRTLAlignment)rtlAlignment {
...
- (TDeskTextRTLAlignment)rtlAlignment {
...
@implementation TDeskCollectionRTLFitFlowLayout
