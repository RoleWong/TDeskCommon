...
/**
 `TDeskAttributedLabel` is a drop-in replacement for `UILabel` that supports `NSAttributedString`, as well as automatically-detected and manually-added links to
 URLs, addresses, phone numbers, and dates.

 ## Differences Between `TDeskAttributedLabel` and `UILabel`

 For the most part, `TDeskAttributedLabel` behaves just like `UILabel`. The following are notable exceptions, in which `TDeskAttributedLabel` may act differently:
 ...
 `TDeskAttributedLabel`, like `UILabel`, conforms to `NSCoding`. However, if the build target is set to less than iOS 6.0, `linkAttributes` and
 ...
 */
@interface TDeskAttributedLabel : UILabel <TDeskAttributedLabel, UIGestureRecognizerDelegate>
...
/**
 ...
 @discussion A `TDeskAttributedLabel` delegate responds to messages sent by tapping on links in the label. You can use the delegate to respond to links
 referencing a URL, address, phone number, date, or date with a specified time zone and duration.
 */
@property(nonatomic, unsafe_unretained) IBOutlet id<TDeskAttributedLabelDelegate> delegate;
 ...
 */
@property(nonatomic, assign) TDeskAttributedLabelVerticalAlignment verticalAlignment;
...
/**
 Adds a link. You can customize an individual link's appearance and accessibility value by creating your own @c TDeskAttributedLabelLink and passing it to this
 ...
 @param link A @c TDeskAttributedLabelLink object.
 */
- (void)addLink:(TDeskAttributedLabelLink *)link;
 ...
 */
- (TDeskAttributedLabelLink *)addLinkWithTextCheckingResult:(NSTextCheckingResult *)result;
...
/**
 ...
 @return The newly added link object.
 */
- (TDeskAttributedLabelLink *)addLinkWithTextCheckingResult:(NSTextCheckingResult *)result attributes:(NSDictionary *)attributes;
...
/**
 ...
 @return The newly added link object.
 */
- (TDeskAttributedLabelLink *)addLinkToURL:(NSURL *)url withRange:(NSRange)range;
...
/**
 ...
 @return The newly added link object.
 */
- (TDeskAttributedLabelLink *)addLinkToAddress:(NSDictionary *)addressComponents withRange:(NSRange)range;
...
/**
 ...
 @return The newly added link object.
 */
- (TDeskAttributedLabelLink *)addLinkToPhoneNumber:(NSString *)phoneNumber withRange:(NSRange)range;
...
/**
 ...
 @return The newly added link object.
 */
- (TDeskAttributedLabelLink *)addLinkToDate:(NSDate *)date withRange:(NSRange)range;
...
/**
 ...
 @return The newly added link object.
 */
- (TDeskAttributedLabelLink *)addLinkToDate:(NSDate *)date timeZone:(NSTimeZone *)timeZone duration:(NSTimeInterval)duration withRange:(NSRange)range;
...
/**
 ...
 @return The newly added link object.
 */
- (TDeskAttributedLabelLink *)addLinkToTransitInformation:(NSDictionary *)components withRange:(NSRange)range;
...
/**
 Returns the @c TDeskAttributedLabelLink at the give point if it exists.

 @discussion This can be used together with @c UIViewControllerPreviewingDelegate to peek into links.

 @param point The point inside the label.
 */
- (TDeskAttributedLabelLink *)linkAtPoint:(CGPoint)point;

@end

/**
 The `TDeskAttributedLabelDelegate` protocol defines the messages sent to an attributed label delegate when links are tapped. All of the methods of this protocol
 are optional.
 */
@protocol TDeskAttributedLabelDelegate <NSObject>
 ...
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didSelectLinkWithURL:(NSURL *)url;
 ...
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didSelectLinkWithAddress:(NSDictionary *)addressComponents;
 ...
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didSelectLinkWithPhoneNumber:(NSString *)phoneNumber;
 ...
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didSelectLinkWithDate:(NSDate *)date;
 ...
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didSelectLinkWithDate:(NSDate *)date timeZone:(NSTimeZone *)timeZone duration:(NSTimeInterval)duration;
...
/**
 ...
 @param components A dictionary containing the transit components. The currently supported keys are `NSTextCheckingAirlineKey` and `NSTextCheckingFlightKey`.
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didSelectLinkWithTransitInformation:(NSDictionary *)components;

/**
 Tells the delegate that the user did select a link to a text checking result.

 @discussion This method is called if no other delegate method was called, which can occur by either now implementing the method in `TDeskAttributedLabelDelegate`
 ...
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didSelectLinkWithTextCheckingResult:(NSTextCheckingResult *)result;
 ...
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didLongPressLinkWithURL:(NSURL *)url atPoint:(CGPoint)point;
...
/**
 ...
 @param point the point pressed, in the label's coordinate space
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didLongPressLinkWithAddress:(NSDictionary *)addressComponents atPoint:(CGPoint)point;
...
/**
 ...
 @param point the point pressed, in the label's coordinate space
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didLongPressLinkWithPhoneNumber:(NSString *)phoneNumber atPoint:(CGPoint)point;
...
/**
 ...
 @param point the point pressed, in the label's coordinate space
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didLongPressLinkWithDate:(NSDate *)date atPoint:(CGPoint)point;
...
/**
 ...
 @param point the point pressed, in the label's coordinate space
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label
...
/**
 ...
 @param point the point pressed, in the label's coordinate space
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didLongPressLinkWithTransitInformation:(NSDictionary *)components atPoint:(CGPoint)point;
...
/**
 ...
 @param point the point pressed, in the label's coordinate space
 */
- (void)attributedLabel:(TDeskAttributedLabel *)label didLongPressLinkWithTextCheckingResult:(NSTextCheckingResult *)result atPoint:(CGPoint)point;

@end

@interface TDeskAttributedLabelLink : NSObject <NSCoding>

typedef void (^TUIAttributedLabelLinkBlock)(TDeskAttributedLabel *, TDeskAttributedLabelLink *);
...
/**
 ...
 @c TDeskAttributedLabelDelegate tap methods, which will not be called for this link.
 */
...
/**
 ...
 @c TDeskAttributedLabelDelegate long press methods, which will not be called for this link.
 */
...
/**
 ...
 @return The initialized link object.
 */
- (instancetype)initWithAttributesFromLabel:(TDeskAttributedLabel *)label textCheckingResult:(NSTextCheckingResult *)result;
