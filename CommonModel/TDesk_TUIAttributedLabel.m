...
// TDeskAttributedLabel.m

#import "TDesk_TUIAttributedLabel.h"
...
NSString *const kTDeskStrikeOutAttributeName = @"TUIStrikeOutAttribute";
NSString *const kTDeskBackgroundFillColorAttributeName = @"TUIBackgroundFillColor";
NSString *const kTDeskBackgroundFillPaddingAttributeName = @"TUIBackgroundFillPadding";
NSString *const kTDeskBackgroundStrokeColorAttributeName = @"TUIBackgroundStrokeColor";
NSString *const kTDeskBackgroundLineWidthAttributeName = @"TUIBackgroundLineWidth";
NSString *const kTDeskBackgroundCornerRadiusAttributeName = @"TUIBackgroundCornerRadius";
...
static inline NSDictionary *formatNSAttributedStringAttributesFromLabel(TDeskAttributedLabel *label) {
...
@interface TDeskAttributedLabel ()
...
@property(readwrite, nonatomic, strong) TDeskAttributedLabelLink *activeLink;
@property(readwrite, nonatomic, strong) NSArray *accessibilityElements;

- (void)longPressGestureDidFire:(UILongPressGestureRecognizer *)sender;
@end

@implementation TDeskAttributedLabel {
@private
...
- (void)addLinks:(NSArray *)links {
    ...
    for (TDeskAttributedLabelLink *link in links) {
        if (link.attributes) {
...
- (NSArray *)addLinksWithTextCheckingResults:(NSArray *)results attributes:(NSDictionary *)attributes {
    ...
    for (NSTextCheckingResult *result in results) {
        ...
        TDeskAttributedLabelLink *link = [[TDeskAttributedLabelLink alloc] initWithAttributes:attributes
...
- (TDeskAttributedLabelLink *)linkAtPoint:(CGPoint)point {
    ...
    TDeskAttributedLabelLink *result = [self linkAtCharacterIndex:[self characterIndexAtPoint:point]];
...
- (TDeskAttributedLabelLink *)linkAtRadius:(const CGFloat)radius aroundPoint:(CGPoint)point {
    ...
    TDeskAttributedLabelLink *link = nil;
...
- (TDeskAttributedLabelLink *)linkAtCharacterIndex:(CFIndex)idx {
...
- (void)drawBackground:(CTFrameRef)frame inRect:(CGRect)rect context:(CGContextRef)c {
    ...
    for (id line in lines) {
        ...
        for (id glyphRun in (__bridge NSArray *)CTLineGetGlyphRuns((__bridge CTLineRef)line)) {
            ...
            CGColorRef strokeColor = formatCGColorRefFromColor([attributes objectForKey:kTDeskBackgroundStrokeColorAttributeName]);
            CGColorRef fillColor = formatCGColorRefFromColor([attributes objectForKey:kTDeskBackgroundFillColorAttributeName]);
            UIEdgeInsets fillPadding = [[attributes objectForKey:kTDeskBackgroundFillPaddingAttributeName] UIEdgeInsetsValue];
            CGFloat cornerRadius = [[attributes objectForKey:kTDeskBackgroundCornerRadiusAttributeName] floatValue];
            CGFloat lineWidth = [[attributes objectForKey:kTDeskBackgroundLineWidthAttributeName] floatValue];
...
- (void)drawStrike:(CTFrameRef)frame inRect:(__unused CGRect)rect context:(CGContextRef)c {
    ...
    for (id line in lines) {
        ...
        for (id glyphRun in (__bridge NSArray *)CTLineGetGlyphRuns((__bridge CTLineRef)line)) {
            NSDictionary *attributes = (__bridge NSDictionary *)CTRunGetAttributes((__bridge CTRunRef)glyphRun);
            BOOL strikeOut = [[attributes objectForKey:kTDeskStrikeOutAttributeName] boolValue];
...
#pragma mark - TDeskAttributedLabel
...
- (void)setActiveLink:(TDeskAttributedLabelLink *)activeLink {
...
- (NSArray *)accessibilityElements {
    if (!_accessibilityElements) {
        @synchronized(self) {
            ...
            for (TDeskAttributedLabelLink *link in self.linkModels) {
...
- (void)longPressGestureDidFire:(UILongPressGestureRecognizer *)sender {
    switch (sender.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            TDeskAttributedLabelLink *link = [self linkAtPoint:touchPoint];
...
#pragma mark - TDeskAttributedLabelLink

@implementation TDeskAttributedLabelLink
...
static inline NSDictionary *convertNSAttributedStringAttributesToCTAttributes(NSDictionary *attributes) {
    ...
    NSDictionary *convertMap = @{
        ...
        NSBackgroundColorAttributeName : (NSString *)kTDeskBackgroundFillColorAttributeName,
