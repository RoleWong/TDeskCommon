...
#import "TDesk_TUIFloatViewController.h"
...
@interface TDeskFloatTitleView ()

@end

@implementation TDeskFloatTitleView
...
@interface TDeskFloatViewController ()
...
@implementation TDeskFloatViewController
...
- (UIView *)topGestureView {
    if (_topGestureView == nil) {
        _topGestureView = [[TDeskFloatTitleView alloc] init];
