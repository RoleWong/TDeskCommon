...
#import <TDeskCore/TDesk_TUIConfig.h>
#import "TDesk_TUIGroupAvatar+Helper.h"

@implementation TDeskGroupAvatar (Helper)
...
+ (UIImage *)getNormalGroupCacheAvatar:(NSString *)groupID groupType:(NSString *)groupType {
    ...
    if (groupID.length > 0) {
         ...
         */
        UIImage *avatar = nil;
        if (TDeskConfig.defaultConfig.enableGroupGridAvatar) {
            ...
            avatar = [TDeskGroupAvatar getCacheAvatarForGroup:groupID number:(UInt32)member];
        }
    ...
    if (groupID.length > 0) {
        ...
        if (IS_NOT_EMPTY_NSSTRING(faceUrl)) {
            ...
            if (TDeskConfig.defaultConfig.enableGroupGridAvatar) {
                ...
                [TDeskGroupAvatar getCacheGroupAvatar:groupID
