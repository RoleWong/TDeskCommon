...
/**
 *  This document declares the TDeskBubbleMessageCell class.
 *  Bubble messages, the most common type of messages that contain strings and emoticons.
 *  Both TDeskIFileMessageCell and TDeskVoiceMessageCell inherit from this class and implement the userinterface of bubble messages.
 ...
 * bubble message unit.
 */
#import "TDesk_TUIBubbleMessageCellData.h"
#import "TDesk_TUIMessageCell.h"
NS_ASSUME_NONNULL_BEGIN

@interface TDeskBubbleMessageCell : TDeskMessageCell
...
@property TDeskBubbleMessageCellData *bubbleData;
...
@interface TDeskBubbleMessageCell (TUILayoutConfiguration)
