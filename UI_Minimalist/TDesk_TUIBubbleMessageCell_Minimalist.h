 ...
 *
 *
 *  This document declares the TDeskBubbleMessageCell_Minimalist class.
...
@interface TDeskBubbleMessageCell_Minimalist : TDeskMessageCell_Minimalist
...
@property(nonatomic, strong) TDeskBubbleMessageCellData *bubbleData;
...
@interface TDeskBubbleMessageCell_Minimalist (TUILayoutConfiguration)
